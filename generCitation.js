...
let citations = [
  ...
  //les recuperation des elements
  let citationDiv = document.querySelector("#citation");
  let auteurDiv = document.querySelector("#auteur");
 ...
 let p = document.querySelector('p');
  ...
  //Detection du click du button
    btn.addEventListener('click', ()=>{
        ...
        citationDiv.textContent = citations[nombreAleatoire][0];
        auteurDiv.textContent   = citations[nombreAleatoire][1];
